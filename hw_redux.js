...
store.dispatch({type: 'ADD_EVEN', payload: {text:'Событие 4'}})
*/

store.dispatch(actionCreaterAddEvent({text: 'Событие 33'}))
...
store.dispatch(actionCreatedRemoveEvent({text: 'Событие 33'}))
store.dispatch(actionCreaterSortEvents())
console.log('store после сортировки и удаления', store.getState())
